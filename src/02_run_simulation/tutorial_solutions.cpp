 ...
 *
 * \brief Simulation of an OpenSim model (build in 01) of a single-legged
 * hopping mechanism.
 *
 * A controller (brain) generates the muscle excitation signal required to
 * produce a small hop when the mechanism is simulated.
 *
